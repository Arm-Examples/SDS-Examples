...
// #warning "Configure algorithm under test input data block size (ALGO_DATA_IN_BLOCK_SIZE) for your algorithm and remove this line!"
...
// #warning "Configure algorithm under test output data block size (ALGO_DATA_OUT_BLOCK_SIZE) for your algorithm and remove this line!"
#define ALGO_DATA_OUT_BLOCK_SIZE        (24 * 10)
#endif
