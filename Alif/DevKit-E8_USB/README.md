# SDS Application for Alif DevKit-E8 with SDSIO using USB Interface
...
3. Connect the PRG USB (J3) of the DevKit-E8 and configure SW4 switch for SETOOLS (SE position).
...
6. Configure SW4 for UART4 (U4 position) and use the VS Code **Serial Monitor** to observe the output below.
7. Connect the MCU USB (J2) of the DevKit-E8 to the PC running SDSIO-Server
