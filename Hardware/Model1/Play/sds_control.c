...
#define PLAY_BUF_SIZE_DATA_IN           ((DATA_IN_BLOCK_SIZE * 2) + 2048)
#endif

#ifndef PLAY_BUF_SIZE_DATA_OUT
#define PLAY_BUF_SIZE_DATA_OUT          ((DATA_OUT_BLOCK_SIZE * 2) + 2048)
#endif
  ...
  for (;;) {
    ...
    switch (sdsio_state) {
      ...
      case SDSIO_HALTED:
        ...
        printf("Playback stopped or reached end of stream\n");
