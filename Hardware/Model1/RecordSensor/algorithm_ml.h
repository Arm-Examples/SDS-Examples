...
#ifndef ALGORITHM_TEST_ML_H_
#define ALGORITHM_TEST_ML_H_
...
/**
  ...
  \return       0 on success; -1 on error
*/
extern int32_t ML_Infer (const uint8_t *in_buf, uint32_t in_num, uint8_t *out_buf, uint32_t out_num);
